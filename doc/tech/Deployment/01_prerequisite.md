...
### External Images
   ...
   For **Kubernetes** context refering to [values.yaml](https://github.com/alchemy-fr/phrasea-helm-charts/blob/main/charts/phrasea/values.yaml)   
...
* Monitoring: Set up yours logging and monitoring for capturing containers standard output (e.g. fluentbits, Prometheus, Grafana).
  * Sentry: [Sentry](https://docs.sentry.io/) Front and Back Agent is incstalled in Phrasea's images, for catching stack error, you can setup yours Sentry [credential here](/tech/Configuration/env_var#php_sentry_dsn).
