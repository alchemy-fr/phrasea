 ...
 */
final class Version20240429130234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE messenger_messages (id BIGSERIAL NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, available_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, delivered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, queue_name VARCHAR(190) NOT NULL, headers TEXT NOT NULL, body TEXT NOT NULL, PRIMARY KEY(id))');
