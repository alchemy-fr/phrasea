...
class ValidateTest extends AbstractUploaderTestCase
{
    protected function setUp(): void
    {
        ...
        $this->request(OAuthClientTestMock::getJwtFor(OAuthClientTestMock::ADMIN_UID), 'POST', '/form-schemas', [
    ...
    {
        $response = $this->request(OAuthClientTestMock::getJwtFor(OAuthClientTestMock::ADMIN_UID), 'POST', '/form/validate', [
            'target' => '/targets/'.$this->getOrCreateDefaultTarget()->getId(),
            'data' => [
                'album' => 'Foo',
                'agreed' => true,
