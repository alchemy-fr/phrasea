...
export default function UploadStepper({
    ...
    const uploadBatch = React.useMemo(() => new UploadBatch(target.id), [target]);
    ...
    const onSubmitForm = React.useCallback((data: FormData) => {
    ...
    return <>
        ...
        {step === Step.Progress && <UploadProgress
