    ...
    return (
        ...
        >
            ...
            {!advancedMode && shares.isSuccess ? (
                <>
                    <LabeledControl
                        label={t('share.public_link', 'Create a public link')}
                    >
                        <Switch
                            checked={!!simpleShare}
                    ...
                    {simpleShare ? (
                        <>
                            ...
                            >
                                <CodeIcon /> {t('share.embed', 'Embed code')}
                            </Button>
                        </>
                    ) : null}
                    <button
            ...
            {advancedMode && shares.isSuccess ? (
                <>
                    ...
                    {creating ? (
                        ...
                        >
                            <PlusIcon />{' '}
                            {t('share.create.button', 'Create new share link')}
                        </Button>
                    )}
                </>
            ) : null}
