...
export type MessageFormHandle = {
    ...
    updateAttachment: (attachmentId: string, handler: UpdateAttachmentHandler) => void;
    clearAttachments: () => void;
    getAttachments: () => DeserializedMessageAttachment[];
};

type UpdateAttachmentHandler = (attachment: DeserializedMessageAttachment) => DeserializedMessageAttachment
