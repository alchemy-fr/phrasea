...
const drawArrow: typeof baseDrawLine = (drawContext, line, options, selected = false) => {
...
export const ArrowAnnotationHandler: DrawingHandler = createLineAnnotationHandler(drawArrow, AnnotationType.Arrow);
