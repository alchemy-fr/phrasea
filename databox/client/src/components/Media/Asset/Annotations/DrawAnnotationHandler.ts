...
function init(context: CanvasRenderingContext2D, options: AnnotationOptions, applyStyle: ApplyStyle | undefined) {
...
export function createDrawAnnotationHandler(
    ...
    onPoint: (props: {context: CanvasRenderingContext2D, point: Point, index: number, options: AnnotationOptions}) => void,
...
export const DrawAnnotationHandler = createDrawAnnotationHandler(AnnotationType.Draw, ({context, point, index}) => {
    if (index === 0) {
