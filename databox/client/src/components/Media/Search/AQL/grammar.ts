...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "operator", "symbols": ["__", "operator$string$1", "__", "number", "__", "operator$string$2", "__", "number"], "postprocess": (data) => ({operator: 'BETWEEN', rightOperand: [data[3], data[7]]})},
    ...
    {"name": "in_operator$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "value"]},
    {"name": "in_operator$ebnf$1", "symbols": ["in_operator$ebnf$1", "in_operator$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "in_operator", "symbols": ["__", "in_operator$string$1", "_", {"literal":"("}, "_", "value", "in_operator$ebnf$1", "_", {"literal":")"}], "postprocess": (data) => {
           return {
               operator: 'IN',
    ...
    {"name": "simple_operator$string$5", "symbols": [{"literal":"i"}, {"literal":"n"}], "postprocess": (d) => d.join('')},
    {"name": "simple_operator", "symbols": ["__", "simple_operator$string$5"], "postprocess": id},
    {"name": "simple_operator$string$6", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"t"}, {"literal":" "}, {"literal":"i"}, {"literal":"n"}], "postprocess": (d) => d.join('')},
