...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "simple_operator", "symbols": ["__", "simple_operator$string$5"], "postprocess": d => d[1]},
    {"name": "simple_operator$string$6", "symbols": [{"literal":"S"}, {"literal":"T"}, {"literal":"A"}, {"literal":"R"}, {"literal":"T"}, {"literal":"S"}], "postprocess": (d) => d.join('')},
    {"name": "simple_operator$string$7", "symbols": [{"literal":"W"}, {"literal":"I"}, {"literal":"T"}, {"literal":"H"}], "postprocess": (d) => d.join('')},
    {"name": "simple_operator", "symbols": ["__", "simple_operator$string$6", "__", "simple_operator$string$7"], "postprocess": () => 'STARTS_WITH'},
