...
const grammar: Grammar = {
    ...
    ParserRules: [
        ...
        {
            name: 'expression$ebnf$1$subexpression$1$string$1',
        ...
        },
        {
            ...
            symbols: [
                '__',
                'expression$ebnf$1$subexpression$1$string$1',
                '__',
                'and_expression',
            ],
        },
        ...
        {
            name: 'expression',
            symbols: ['and_expression', 'expression$ebnf$1'],
        ...
        {
            name: 'and_expression$ebnf$1$subexpression$1$string$1',
            symbols: [{literal: 'A'}, {literal: 'N'}, {literal: 'D'}],
            postprocess: d => d.join(''),
        },
        {
            name: 'and_expression$ebnf$1$subexpression$1',
            symbols: [
                '__',
                'and_expression$ebnf$1$subexpression$1$string$1',
                '__',
                'condition',
            ],
        },
        {
            name: 'and_expression$ebnf$1',
            symbols: [
                'and_expression$ebnf$1',
                'and_expression$ebnf$1$subexpression$1',
            ],
            postprocess: d => d[0].concat([d[1]]),
        },
        {
            name: 'and_expression',
            symbols: ['condition', 'and_expression$ebnf$1'],
            postprocess: function (data) {
                const conditions = [data[0]];
        ...
        {
            name: 'condition',
            symbols: ['condition$string$1', '__', 'expression'],
            postprocess: data => ({operator: 'NOT', conditions: [data[3]]}),
        },
        {name: 'condition', symbols: ['criteria'], postprocess: id},
        {
            name: 'criteria',
            symbols: ['field', '_', 'operator'],
            postprocess: function (data) {
                return {
                    leftOperand: data[0],
                    ...data[2],
        ...
        {
            name: 'operator$ebnf$1$subexpression$1$string$1',
            symbols: [{literal: 'N'}, {literal: 'O'}, {literal: 'T'}],
            postprocess: d => d.join(''),
        },
        {
            name: 'operator$ebnf$1$subexpression$1',
            symbols: ['operator$ebnf$1$subexpression$1$string$1', '__'],
        },
        {
            name: 'operator$ebnf$1',
            symbols: ['operator$ebnf$1$subexpression$1'],
            postprocess: id,
        },
        ...
        },
        {
            ...
            postprocess: data => ({
                operator: data[1] ? 'NOT_BETWEEN' : 'BETWEEN',
                rightOperand: [data[4], data[8]],
            }),
        },
        {
        ...
        {
            name: 'operator',
            symbols: ['__', 'operator$string$3', '__', 'operator$string$4'],
        ...
        {
            name: 'operator',
            symbols: ['simple_operator', '_', 'value_expression'],
            postprocess: data => ({operator: data[0], rightOperand: data[2]}),
        },
        {
            name: 'geo_operator$string$1',
            symbols: [
                {literal: 'W'},
                {literal: 'I'},
                {literal: 'T'},
        ...
        {
            name: 'geo_operator$subexpression$1',
            symbols: ['within_circle_operator'],
        },
        {
            name: 'geo_operator$subexpression$1',
            symbols: ['within_rectangle_operator'],
        },
        {
            name: 'geo_operator',
            symbols: [
                'geo_operator$string$1',
                '__',
                'geo_operator$subexpression$1',
            ],
            postprocess: data => {
                return data[2][0];
            },
        ...
        {
            name: 'within_circle_operator$string$1',
            symbols: [
                {literal: 'C'},
                {literal: 'I'},
                {literal: 'R'},
        ...
        {
            name: 'within_circle_operator',
            symbols: [
                'within_circle_operator$string$1',
                '_',
                {literal: '('},
                '_',
                'value_expression',
            ...
            postprocess: data => {
                return {
                    ...
                    rightOperand: [data[4], data[8], data[12]],
                };
            },
        },
        {
            name: 'within_rectangle_operator$string$1',
            symbols: [
                {literal: 'R'},
                {literal: 'E'},
                {literal: 'C'},
        ...
        {
            name: 'within_rectangle_operator',
            symbols: [
                'within_rectangle_operator$string$1',
                '_',
                {literal: '('},
                '_',
                'value_expression',
            ...
            postprocess: data => {
                return {
                    ...
                    rightOperand: [data[4], data[8], data[12], data[16]],
                };
            },
        },
        {
        ...
        {
            name: 'simple_operator$string$1',
            symbols: [{literal: '!'}, {literal: '='}],
            postprocess: d => d.join(''),
        },
        {
            name: 'simple_operator',
            symbols: ['simple_operator$string$1'],
            postprocess: id,
        },
        {name: 'simple_operator', symbols: [{literal: '>'}], postprocess: id},
        {name: 'simple_operator', symbols: [{literal: '<'}], postprocess: id},
        {
            name: 'simple_operator$string$2',
            symbols: [{literal: '>'}, {literal: '='}],
            postprocess: d => d.join(''),
        },
        {
            name: 'simple_operator',
            symbols: ['simple_operator$string$2'],
            postprocess: id,
        },
        {
            name: 'simple_operator$string$3',
            symbols: [{literal: '<'}, {literal: '='}],
            postprocess: d => d.join(''),
        },
        {
            name: 'simple_operator',
            symbols: ['simple_operator$string$3'],
            postprocess: id,
        },
        {
            name: 'simple_operator$string$4',
            symbols: [
                {literal: 'C'},
                {literal: 'O'},
                {literal: 'N'},
        ...
        {
            name: 'simple_operator',
            symbols: ['__', 'simple_operator$string$4'],
            postprocess: d => d[1],
        },
        {
            name: 'simple_operator$string$5',
            symbols: [
                {literal: 'D'},
                {literal: 'O'},
                {literal: 'E'},
        ...
        {
            name: 'simple_operator$string$6',
            symbols: [{literal: 'N'}, {literal: 'O'}, {literal: 'T'}],
            postprocess: d => d.join(''),
        },
        {
            name: 'simple_operator$string$7',
            symbols: [
                {literal: 'C'},
                {literal: 'O'},
                {literal: 'N'},
        ...
        },
        {
            name: 'simple_operator',
            symbols: [
                'simple_operator$string$5',
                '__',
                'simple_operator$string$6',
                '__',
                'simple_operator$string$7',
            ],
            postprocess: () => 'NOT_CONTAINS',
        },
        {
            name: 'simple_operator$string$8',
            symbols: [
                {literal: 'M'},
                {literal: 'A'},
                {literal: 'T'},
        ...
        {
            name: 'simple_operator',
            symbols: ['__', 'simple_operator$string$8'],
            postprocess: d => d[1],
        },
        {
            name: 'simple_operator$string$9',
            symbols: [
                {literal: 'D'},
                {literal: 'O'},
                {literal: 'E'},
        ...
        {
            name: 'simple_operator$string$10',
            symbols: [{literal: 'N'}, {literal: 'O'}, {literal: 'T'}],
            postprocess: d => d.join(''),
        },
        {
            name: 'simple_operator$string$11',
            symbols: [
                {literal: 'M'},
                {literal: 'A'},
                {literal: 'T'},
        ...
        },
        {
            name: 'simple_operator',
            symbols: [
                'simple_operator$string$9',
                '__',
                'simple_operator$string$10',
                '__',
                'simple_operator$string$11',
            ],
            postprocess: () => 'NOT_MATCHES',
        },
        {
            name: 'simple_operator$string$12',
            symbols: [
                {literal: 'S'},
                {literal: 'T'},
                {literal: 'A'},
        ...
        {
            name: 'simple_operator$string$13',
            symbols: [
                {literal: 'W'},
                {literal: 'I'},
                {literal: 'T'},
        ...
        },
        {
            ...
            symbols: [
                '__',
                'simple_operator$string$12',
                '__',
                'simple_operator$string$13',
            ],
            postprocess: () => 'STARTS_WITH',
        },
        {
            name: 'simple_operator$string$14',
            symbols: [
                {literal: 'D'},
                {literal: 'O'},
                {literal: 'E'},
        ...
        {
            name: 'simple_operator$string$15',
            symbols: [{literal: 'N'}, {literal: 'O'}, {literal: 'T'}],
            postprocess: d => d.join(''),
        },
        {
            name: 'simple_operator$string$16',
            symbols: [
                {literal: 'S'},
                {literal: 'T'},
                {literal: 'A'},
        ...
        {
            name: 'simple_operator$string$17',
            symbols: [
                {literal: 'W'},
                {literal: 'I'},
                {literal: 'T'},
        ...
        },
        {
            name: 'simple_operator',
            symbols: [
                'simple_operator$string$14',
                '__',
                'simple_operator$string$15',
                '__',
                'simple_operator$string$16',
                '__',
                'simple_operator$string$17',
            ],
            postprocess: () => 'NOT_STARTS_WITH',
        },
        {
            name: 'function_call$ebnf$1',
            symbols: ['value_expression'],
            postprocess: id,
        },
        {name: 'function_call$ebnf$1', symbols: [], postprocess: () => null},
        {name: 'function_call$ebnf$2', symbols: []},
        {
            name: 'function_call$ebnf$2$subexpression$1',
            symbols: ['_', {literal: ','}, '_', 'value_expression'],
        },
        {
            name: 'function_call$ebnf$2',
            symbols: [
                'function_call$ebnf$2',
                'function_call$ebnf$2$subexpression$1',
            ],
            postprocess: d => d[0].concat([d[1]]),
        },
        {
        ...
        {
            name: 'value_product$ebnf$1$subexpression$1$subexpression$1',
            symbols: [{literal: '/'}],
        },
        {
            name: 'value_product$ebnf$1$subexpression$1$subexpression$1',
        ...
        {
            name: 'value_product$ebnf$1$subexpression$1',
            symbols: [
                '_',
                'value_product$ebnf$1$subexpression$1$subexpression$1',
                '_',
                'value_or_expr',
            ],
        },
        {
            name: 'value_product$ebnf$1',
            symbols: [
                'value_product$ebnf$1',
                'value_product$ebnf$1$subexpression$1',
            ],
            postprocess: d => d[0].concat([d[1]]),
        },
        {
            name: 'value_product',
            symbols: ['value_or_expr', 'value_product$ebnf$1'],
            postprocess: data => {
        ...
        {
            name: 'value_sum$ebnf$1$subexpression$1$subexpression$1',
            symbols: [{literal: '+'}],
        },
        {
            name: 'value_sum$ebnf$1$subexpression$1$subexpression$1',
        ...
        {
            name: 'value_sum$ebnf$1$subexpression$1',
            symbols: [
                '_',
                'value_sum$ebnf$1$subexpression$1$subexpression$1',
                '_',
                'value_product',
            ],
        },
        {
            name: 'value_sum$ebnf$1',
            symbols: ['value_sum$ebnf$1', 'value_sum$ebnf$1$subexpression$1'],
            postprocess: d => d[0].concat([d[1]]),
        },
        {
            name: 'value_sum',
            symbols: ['value_product', 'value_sum$ebnf$1'],
            postprocess: data => {
                function handleOperator(l, r, operator) {
                    return {
                        type: 'value_expression',
        ...
        {name: 'quoted_string$ebnf$1$subexpression$1', symbols: [/[^"]/]},
        {
            ...
            symbols: [
                ...
                'quoted_string$ebnf$1$subexpression$1',
            ],
            postprocess: d => d[0].concat([d[1]]),
        },
        {
            name: 'quoted_string',
            symbols: [{literal: '"'}, 'quoted_string$ebnf$1', {literal: '"'}],
            postprocess: d => ({literal: d[1].join('')}),
        },
        {name: 'quoted_string$ebnf$2', symbols: []},
        {
            name: 'quoted_string$ebnf$2$subexpression$1',
            symbols: ['escape_single'],
        },
        {name: 'quoted_string$ebnf$2$subexpression$1', symbols: [/[^']/]},
        {
            name: 'quoted_string$ebnf$2',
            symbols: [
                'quoted_string$ebnf$2',
                'quoted_string$ebnf$2$subexpression$1',
            ],
            postprocess: d => d[0].concat([d[1]]),
        },
        {
            name: 'quoted_string',
            symbols: [{literal: "'"}, 'quoted_string$ebnf$2', {literal: "'"}],
            postprocess: d => ({literal: d[1].join('')}),
        },
