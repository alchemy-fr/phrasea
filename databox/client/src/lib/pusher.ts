import {createPusher, PusherEventCallback, registerPusherWs} from '@alchemy/core';
...
export function registerWs(channel: string, event: string, callback: PusherEventCallback) {
