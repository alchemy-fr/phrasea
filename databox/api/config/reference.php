 ...
 * @psalm-type AlchemyCoreConfig = array{
 *     app_name?: scalar|Param|null,
 *     app_id?: scalar|Param|null, // Default: "%env(APP_ID)%"
 *     app_url?: scalar|Param|null, // Default: null
 *     healthcheck?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *     },
 *     pusher?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         disabled?: bool|Param, // Default: false
 *         host?: scalar|Param|null, // Default: "%env(SOKETI_HOST)%"
 *         key?: scalar|Param|null, // Default: "%env(SOKETI_KEY)%"
 ...
 * }
 * @psalm-type AlchemyAclConfig = array{
 *     enabled_permissions?: list<scalar|Param|null>,
 *     objects?: array<string, scalar|Param|null>,
 * }
 * @psalm-type AlchemyAuthConfig = array{
 *     keycloak?: array{
 *         url?: scalar|Param|null, // Default: "%env(KEYCLOAK_URL)%"
 *         internal_url?: scalar|Param|null, // Default: "%env(default::KEYCLOAK_INTERNAL_URL)%"
 *         realm?: scalar|Param|null, // Default: "%env(KEYCLOAK_REALM_NAME)%"
 *     },
 ...
 *         name?: scalar|Param|null, // The name of the service hosting the admin (in order to access the config node)
 *     },
 *     worker?: array{
 *         queues?: list<scalar|Param|null>,
 *         rabbitmq?: array{
 *             host?: scalar|Param|null, // Default: "%env(RABBITMQ_HOST)%"
 *             port?: scalar|Param|null, // Default: "%env(RABBITMQ_PORT)%"
 *             user?: scalar|Param|null, // Default: "%env(RABBITMQ_USER)%"
 *             password?: scalar|Param|null, // Default: "%env(RABBITMQ_PASSWORD)%"
 *             vhost?: scalar|Param|null, // Default: "%env(RABBITMQ_VHOST)%"
 *         },
 *     },
 * }
 ...
 * }
 * @psalm-type AlchemyStorageConfig = array{
 *     upload?: array{
 *         allowed_types?: scalar|Param|null, // comma separated values of MIME types, optionally including their extensions // Default: "%env(ALLOWED_FILE_TYPES)%"
 *     },
 * }
 ...
 *     }>,
 * }
 * @psalm-type AlchemyWebhookConfig = array{
 *     events?: array<string, array{ // Default: []
 *         description?: scalar|Param|null, // Default: "/"
 *     }>,
 *     normalizer_roles?: list<scalar|Param|null>,
 *     entities?: array<string, array{ // Default: []
 *         name?: scalar|Param|null,
 *         groups?: list<scalar|Param|null>,
 *         create?: bool|array{
 ...
 *             enabled?: bool|Param, // Default: true
 *         },
 *         ignoreProperties?: list<scalar|Param|null>,
 *     }>,
 * }
 ...
 *     }>,
 * }
 * @psalm-type AlchemyMetadataManipulatorConfig = array{
 *     debug?: bool|Param, // Default: false
 *     classes_directory?: scalar|Param|null, // Default: "%kernel.cache_dir%/phpexiftool"
 * }
 ...
 *     pusher?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         channel_prefix?: scalar|Param|null, // Default: "workflow-"
 *     },
 * }
 ...
 *     },
 * }
 * @psalm-type ArthemObjectReferenceConfig = array{
 *     mapping?: array<string, scalar|Param|null>,
 * }
 * @psalm-type AlchemyConfiguratorConfig = array{
 *     database_url?: scalar|Param|null, // Default: "%env(CONFIGURATOR_DATABASE_URL)%"
 *     storage?: array{
 *         bucket_name?: scalar|Param|null, // Default: "%env(CONFIGURATOR_S3_BUCKET_NAME)%"
 *         use_path_style_endpoint?: bool|Param, // Default: "%env(bool:CONFIGURATOR_S3_USE_PATH_STYLE_ENDPOINT)%"
 *         endpoint?: scalar|Param|null, // Default: "%env(CONFIGURATOR_S3_ENDPOINT)%"
 *         path_prefix?: scalar|Param|null, // Default: "%env(CONFIGURATOR_S3_PATH_PREFIX)%"
 *         access_key?: scalar|Param|null, // Default: "%env(CONFIGURATOR_S3_ACCESS_KEY)%"
 *         secret_key?: scalar|Param|null, // Default: "%env(CONFIGURATOR_S3_SECRET_KEY)%"
 *         region?: scalar|Param|null, // Default: "%env(CONFIGURATOR_S3_REGION)%"
 *     },
 * }
 ...
 * }
 * @psalm-type AlchemyNotifyConfig = array{
 ...
 *     alchemy_core?: AlchemyCoreConfig,
 ...
 *     alchemy_acl?: AlchemyAclConfig,
 *     alchemy_auth?: AlchemyAuthConfig,
 *     alchemy_admin?: AlchemyAdminConfig,
 *     monolog?: MonologConfig,
 *     alchemy_storage?: AlchemyStorageConfig,
 *     oneup_flysystem?: OneupFlysystemConfig,
 *     alchemy_webhook?: AlchemyWebhookConfig,
 *     exercise_html_purifier?: ExerciseHtmlPurifierConfig,
 *     alchemy_metadata_manipulator?: AlchemyMetadataManipulatorConfig,
 *     alchemy_workflow?: AlchemyWorkflowConfig,
 *     alchemy_es?: AlchemyEsConfig,
 *     sentry?: SentryConfig,
 *     arthem_object_reference?: ArthemObjectReferenceConfig,
