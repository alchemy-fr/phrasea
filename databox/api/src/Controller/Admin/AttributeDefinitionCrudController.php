...
class AttributeDefinitionCrudController extends AbstractAdminCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        $initializersAll = TextareaField::new('initializersAll');
        ...
        if (Crud::PAGE_INDEX === $pageName) {
            ...
            return [$workspace, $class, $name, $fileType, $fieldType, $allowInvalid, $sortable, $translatable, $multiple, $searchable, $searchBoost, $initializersAll, $fallbackAll, $fallbackEN, $fallbackFR];
