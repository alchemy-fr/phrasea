...
final class Version20260903080000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE terms_version (id UUID NOT NULL, workspace_id UUID NOT NULL, file_id UUID DEFAULT NULL, version INT NOT NULL, text TEXT NOT NULL, checksum VARCHAR(64) DEFAULT NULL, translations JSON DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_620E039182D40A1F ON terms_version (workspace_id)');
        $this->addSql('CREATE INDEX IDX_620E039193CB796C ON terms_version (file_id)');
        ...
        $this->addSql('COMMENT ON COLUMN terms_version.file_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE terms_version ADD CONSTRAINT FK_620E039193CB796C FOREIGN KEY (file_id) REFERENCES file (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
