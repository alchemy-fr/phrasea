...
final class Version20260316144506 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO access_control_entry (id, user_type, user_id, object_type, object_id, mask, created_at) SELECT gen_random_uuid(), rr.user_type, rr.user_id, \'rendition_policy\' AS object_type, a.rendition_policy_id AS object_id, 513 AS permission, rr.created_at AS created_at FROM sdr_allowed a INNER JOIN rendition_rule rr ON a.rendition_rule_id = rr.id');
