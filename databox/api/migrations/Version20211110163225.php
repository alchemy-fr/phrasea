 ...
 */
final class Version20211110163225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attribute_definition ADD fallback TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE attribute_definition DROP fallbacks');
    }
