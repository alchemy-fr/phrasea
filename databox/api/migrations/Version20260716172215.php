...
final class Version20260716172215 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create tables for notifier bundle: notification, preference, subscriber, subscription';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE notifier_notification (id UUID NOT NULL, subscriber_id UUID NOT NULL, topic VARCHAR(255) NOT NULL, subject VARCHAR(255) DEFAULT NULL, content TEXT DEFAULT NULL, data JSON NOT NULL, read_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE notifier_subscription (id UUID NOT NULL, subscriber_id UUID NOT NULL, topic VARCHAR(100) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, object_type VARCHAR(30) DEFAULT NULL, object_id VARCHAR(36) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX uniq_notifier_subscription ON notifier_subscription (subscriber_id, object_type, object_id)');
