 ...
 */
final class Version20250507082828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE attribute_list_definition (id UUID NOT NULL, list_id UUID NOT NULL, definition_id UUID DEFAULT NULL, type SMALLINT NOT NULL, key VARCHAR(150) DEFAULT NULL, position INT NOT NULL, format VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE UNIQUE INDEX list_def_uniq ON attribute_list_definition (list_id, definition_id, key, type)
        SQL);
        $this->addSql(<<<'SQL'
